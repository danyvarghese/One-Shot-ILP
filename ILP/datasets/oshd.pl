...
example(alphabet(character_0),-3).
example(alphabet(character_1),-3).
example(alphabet(character_2),-3).
example(alphabet(character_3),-3).
example(alphabet(character_4),-3).
example(alphabet(character_5),-3).
example(alphabet(character_6),-3).
example(alphabet(character_7),-3).
example(alphabet(character_8),-3).
example(alphabet(character_9),-3).
example(alphabet(character_10),-3).
example(alphabet(character_11),-3).
example(alphabet(character_12),-3).
example(alphabet(character_13),-3).
example(alphabet(character_14),-3).
example(alphabet(character_15),-3).
example(alphabet(character_16),-3).
example(alphabet(character_17),-3).
